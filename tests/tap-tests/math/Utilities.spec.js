...
test('Utilities', function(t) {
    ...
    t.test('length method', function(t) {
        ...
        // TODO doesn't yet throw errors for every type other than "number"
        // var types = new TypeList().removeNumbers();
        // types.forEach(function(type) {
        //     t.throws(function() {
        //         Utilities.length([type, type, type]);
        //     }, void 0, 'should throw if passed anything but a numerical array');
        //     t.throws(function() {
        //         Utilities.length(type);
        //     }, void 0, 'should throw if passed anything but a numerical array');
        // });
